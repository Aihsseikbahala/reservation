...
<template>
    <section class="d-flex">
        <nav class="navbar navbar-expand-lg navbar-light" id="headme"
           >
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <RouterLink to="/BoatList" class="nav-link">Boat List</RouterLink>
                        </li>
                        <li class="nav-item">
                            <RouterLink to="/BoatOwner" class="nav-link">Tourist Reservation</RouterLink>
                        </li>
        ...
        <div v-for="(item,index) in items" :key="item.boat_owner_id" class="d-none d-lg-block"
            style="box-shadow: rgba(17, 17, 26, 0.1) 0px 1px 0px;">

            <div v-if="id == item.boat_owner_id" class="d-flex my-2">
                <img :src="'/@fs/xampp/htdocs/reservation/src/assets/uploads/' + item.boat_owner_img" @click="isSet"
                    style="width: 35px;height: 35px;border-radius: 50%; margin-left: 15px;"
                    :data-bs-target="'#bookmodal-' + item.boat_owner_id">
                <div href="" class="d-none d-md-block my-1 text-decoration-none text-dark "
                    ...
                    {{ item.boat_owner_fname }} {{ item.boat_owner_lname }}</div>
                    ...
                    <div class="modal-dialog modal-fullscreen modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <button type="button" class="btn-close" @click="closeProfile" data-bs-dismiss="modal" aria-label="Close"
                                    style="z-index:5;"></button>
                            </div>
                            <div class="modal-body">
                                <div class="card text-center">
                                    ...
                                    <div v-if="isImage"
                                        ...
                                        @click="image2">
                                        <img v-if="isImage2"
                                            :src="'/@fs/xampp/htdocs/reservation/src/assets/uploads/' + item.boat_owner_img"
                                            class="wide">
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <span class="m-2">{{ item.boat_owner_address }}</span>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12 d-block">
                                                <strong>{{ item.boat_owner_fname }} {{ item.boat_owner_lname }}</strong>
                                                <div class="m-2 text-muted">{{ item.boat_owner_email }}</div>
                                            </div>
                                        </div>
                                    </div>
