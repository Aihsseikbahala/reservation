...
<template>
    <div class="container d-flex justify-content-center mt-5" style="width: 100%; height:100%; position:fixed; top:0;left:0; z-index: 99;">
	<div class="card">
		...
		<div>
			...
			<div><img src="https://www.brodneil.com/wp-content/uploads/2022/05/gcash-logo-1.png" width="120" height="60" style="margin-top:8px;"/></div>
			<div class="mt-3 pl-2"><span class="name">Mark Ja***</span><div><span class="cross"></span><span class="pin ml-2">8880</span></div></div>
		    </div>
