                                    ...
                                    <tr v-if="item.Tourist_id == id">
                                        ...
                                        <td>
                                            <button class="status-button bg-completed" v-if="item.status === 'completed'">{{
                                                item.status }}</button>
                                            <button class="status-button bg-reserve"
                                                v-else-if="item.status === 'reserve'">{{
                                                    item.status }}</button>
                                            <button class="status-button bg-canceled"
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Boat Reservation Receipt</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mt-4">
                                                                ...
                                                                <p>Thank you for choosing Spot Paradise for your boat
                                                                    reservation. We are excited to have you on board!</p>
                                                                <p>Here are the details of your reservation:</p>
                                                                <ul class="list-group">
                                                                    <li class="list-group-item"><strong>Reservation
                                                                            ID:</strong> {{ item.id }}</li>
                                                                    <li class="list-group-item"><strong>Tourist
                                                                            Name:</strong> {{ item.fname }} {{ item.lname }}
                                                                    </li>
                                                                    <li class="list-group-item">
                                                                        <strong>Destination:</strong> {{ item.destination }}
                                                                    </li>
                                                                    <li class="list-group-item"><strong>Boat Name:</strong>
                                                                        {{ item.boatName }}</li>
                                                                    <li class="list-group-item"><strong>Tour Guide:</strong>
                                                                        {{ item.tourguide }}</li>
                                                                    <li class="list-group-item"><strong>Reservation
                                                                            Date:</strong> {{ item.reservationDate }}</li>
                                                                    ...
                                                                    <li class="list-group-item"><strong>Total
                                                                            Price:</strong> {{ item.totalPrice }}</li>
                                                                </ul>
                                                                <p class="mt-3">We look forward to providing you with an
                                                                    unforgettable experience. If you have any questions or
                                                                    need further assistance, please feel free to contact us.
                                                                </p>
                                                                <p>Safe travels and enjoy your time at Spot Paradise!</p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="modal-body">
                                                            <form>
                                                                ...
                                                                <div class="mb-3 " style="width:100%">
                                                                    <label for="boatType" class="form-label">Boat
                                                                        Type</label>
                                                                    <select class="form-select" id="boatType"
                                                                        v-model="reserve.boatName.value" @change="findBoat">

                                                                        <option v-for="boat in boats"
                                                                            :key="boat.boatDetails_id"
                                                                ...
                                                                <div class='desc'>
                                                                    <div v-if="reserve.boatName.value">
                                                                        <template v-for="boat in boats"
                                                                            :key="boat.boatDetails_id">
                                                                            <div v-if="reserve.boatName.value[1] === boat.boatName"
                                                                                class="card " style="margin-top:10px;">
                                                                                <section>
                                                                                    <img :src="'/@fs/reservation/src/assets/uploads/' + boat.Bimag1"
                                            ...
                                            > -->
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="button" class="btn btn-primary"
                                                                        @click="updateReserve(item.Tourist_id, item.id)">
                                                                        Save changes
                                                                    </button>
                                                                </div>
                                                            </form>
